...
function Card({ image, content, setopenComponent, value }) {
  return (
    <>
      <div onClick={() => setopenComponent(value)} className="flex cursor-pointer justify-center text-center m-5 flex-wrap border-[#ECECEC] border-[8px] rounded-3xl border-solid hover:shadow-md">
